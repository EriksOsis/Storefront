        ...
        data.category.products.map((product) => (
            params.category === product.category ?
                <div key={product.id} id={product.id}
                     className={product.inStock ? classes['prod-card'] : classes['prod-card-oos']}>
                    <Link to={'/product/' + product.id} className={classes.fix}>
                        <img className={classes['prod-img']} src={product.gallery[0]} alt={product.name}/>
                        <p className={classes.title}>{`${product.brand} ${product.name}`}</p>
                    ...
                    <button ref={ref} onClick={props.onAddToCart} className={classes['quick-add']}>
                ...
                : params.category === 'all' &&
                <div key={product.id} className={product.inStock ? classes['prod-card'] : classes['prod-card-oos']}>
                    <Link to={'/product/' + product.id} className={classes.fix}>
                        <img className={classes['prod-img']} src={product.gallery[0]} alt={product.name}/>
                        <p className={classes.title}>{`${product.brand} ${product.name}`}</p>
                        <p className={classes.price}>
