            ...
            {({loading, error, data}) => {
                ...
                return (
                    <div className={classes.all}>
                        <nav>
                            <Categories onClose={this.hideCartHandler}/>
                            <svg className={classes.logo} xmlns="http://www.w3.org/2000/svg" width="41" height="41"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_150_357" x1="29.8733" y1="31.3337" x2="11.5132"
                                                    y2="9.9008"
                            ...
                            <div className={classes['nav-icons']}>
                                <button className={classes['select-btn']}
                                        onClick={this.props.onOpen}>{this.props.currencyId}
                                    <svg className={this.props.arrowClasses} width="8" height="4" viewBox="0 0 8 4"
                                         fill="none"
                                ...
                                <div className={classes.cart}>
                                    <svg className={classes['cart-btn']}
                                         onClick={numOfCartItems !== 0 ? this.showCartHandler : undefined} width="20"
                                         height="20" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    {numOfCartItems !== 0 && <p className={classes.badge}>{numOfCartItems}</p>}
                                </div>
                            </div>
                        </nav>
                        {this.state.cartIsShown &&
                            <Cart numOfCartItems={numOfCartItems} currencyId={this.props.currencyId}
                                  onClose={this.hideCartHandler}/>}
                    </div>
                )
